...
class ProfileAvatar extends Model
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            [['imageFiles'], 'file', 'maxFiles' => 5,'mimeTypes' => ['image/jpeg', 'image/pjpeg', 'image/png'], 'extensions' => ['jpg', 'jpeg', 'png'], 'maxSize' => 1.5*1024*1024, 'message' => 'Файл не соответствует требованиям'],
        ];
