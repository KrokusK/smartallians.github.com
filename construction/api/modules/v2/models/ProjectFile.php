...
class ProjectFile extends Model
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            [['imageFiles'], 'file', 'maxFiles' => 2, 'maxSize' => 5*1024*1024, 'message' => 'Файл не соответствует требованиям'],
        ];

    }

    /**
     * upload project document to the server
     */
    public function upload()
    {
        if ($this->validate()) {
            ...
            // get images for each document and save to the server as random filenames
            foreach ($this->imageFiles as $image) {
                if (!empty($image) && $image->size !== 0) {
                    ...
                    Yii::$app->params['uploadPath'] = Yii::$app->basePath . '/web/uploads/document/';
