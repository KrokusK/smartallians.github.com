...
class KindUserController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($modelKindUser->validate()) {
            ...
            //return Json::encode(array('method' => 'POST', 'status' => '0', 'type' => 'success', 'message' => 'Отклик успешно сохранен', var_dump($bodyRaw), var_dump(ArrayHelper::toArray($modelKindUser))));
    ...
    public function actionUpdate()
    {
        ...
        //if (Yii::$app->request->isAjax) {
            ...
            if ($modelKindUser->validate()) {
                ...
                //return Json::encode(array('method' => 'PUT', 'status' => '0', 'type' => 'success', 'message' => 'Отклик успешно сохранен (обновлен)', var_dump($bodyRaw), var_dump(ArrayHelper::toArray($modelKindUser))));
    ...
    public function actionDelete()
    {
        ...
        if (!empty($modelKindUser)) {
            ...
            //return Json::encode(array('method' => 'PUT', 'status' => '0', 'type' => 'success', 'message' => 'Отклик успешно удален', var_dump($bodyRaw), var_dump(ArrayHelper::toArray($modelKindUser))));
