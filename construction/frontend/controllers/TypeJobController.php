...
class TypeJobController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($modelTypeJob->validate()) {
            ...
            //return Json::encode(array('method' => 'POST', 'status' => '0', 'type' => 'success', 'message' => 'Отклик успешно сохранен', var_dump($bodyRaw), var_dump(ArrayHelper::toArray($modelTypeJob))));
    ...
    public function actionUpdate()
    {
        ...
        //if (Yii::$app->request->isAjax) {
            ...
            if ($modelTypeJob->validate()) {
                ...
                //return Json::encode(array('method' => 'PUT', 'status' => '0', 'type' => 'success', 'message' => 'Отклик успешно сохранен (обновлен)', var_dump($bodyRaw), var_dump(ArrayHelper::toArray($modelTypeJob))));
    ...
    public function actionDelete()
    {
        ...
        if (!empty($modelTypeJob)) {
            ...
            //return Json::encode(array('method' => 'PUT', 'status' => '0', 'type' => 'success', 'message' => 'Отклик успешно удален', var_dump($bodyRaw), var_dump(ArrayHelper::toArray($modelTypeJob))));
