...
class KindJobController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($modelKindJob->validate()) {
            ...
            //return Json::encode(array('method' => 'POST', 'status' => '0', 'type' => 'success', 'message' => 'Отклик успешно сохранен', var_dump($bodyRaw), var_dump(ArrayHelper::toArray($modelKindJob))));
    ...
    public function actionUpdate()
    {
        ...
        //if (Yii::$app->request->isAjax) {
            ...
            if ($modelKindJob->validate()) {
                ...
                //return Json::encode(array('method' => 'PUT', 'status' => '0', 'type' => 'success', 'message' => 'Отклик успешно сохранен (обновлен)', var_dump($bodyRaw), var_dump(ArrayHelper::toArray($modelKindJob))));
    ...
    public function actionDelete()
    {
        ...
        if (!empty($modelKindJob)) {
            ...
            //return Json::encode(array('method' => 'PUT', 'status' => '0', 'type' => 'success', 'message' => 'Отклик успешно удален', var_dump($bodyRaw), var_dump(ArrayHelper::toArray($modelKindJob))));
