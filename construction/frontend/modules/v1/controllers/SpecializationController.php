...
use frontend\modules\v1\models\Specialization;
use Yii;
            ...
            if ($modelSpecialization->validate()) {
                ...
                try {
                    ...
                    if ($flag == true) {
                        ...
                        $transaction->rollBack();
                        return Json::encode(array('method' => 'PUT', 'status' => '1', 'type' => 'error', 'message' => 'Ошибка: Специализация не может быть сохранена (обновлена)'));
                    }
                } catch (Exception $ex) {
                    $transaction->rollBack();
                    return Json::encode(array('method' => 'PUT', 'status' => '1', 'type' => 'error', 'message' => 'Ошибка: Специализация не может быть сохранена (обновлена)'));
                ...
                //return Json::encode(array('method' => 'PUT', 'status' => '0', 'type' => 'success', 'message' => 'Специализация успешно сохранена (обновлена)', var_dump($bodyRaw), var_dump(ArrayHelper::toArray($modelSpecialization))));
                return Json::encode(array('method' => 'PUT', 'status' => '0', 'type' => 'success', 'message' => 'Специализация успешно сохранена (обновлена)'));
            } else {
        ...
        if (!empty($modelSpecialization)) {
            ...
            try {
                ...
                if ($flag == true) {
                    ...
                    $transaction->rollBack();
                    return Json::encode(array('method' => 'PUT', 'status' => '1', 'type' => 'error', 'message' => 'Ошибка: Специализация не может быть удален'));
                }
            } catch (Exception $ex) {
                $transaction->rollBack();
                return Json::encode(array('method' => 'PUT', 'status' => '1', 'type' => 'error', 'message' => 'Ошибка: Специализация не может быть удален'));
            ...
            //return Json::encode(array('method' => 'PUT', 'status' => '0', 'type' => 'success', 'message' => 'Специализация успешно удален', var_dump($bodyRaw), var_dump(ArrayHelper::toArray($modelSpecialization))));
            return Json::encode(array('method' => 'PUT', 'status' => '0', 'type' => 'success', 'message' => 'Специализация успешно удален'));
        } else {
            return Json::encode(array('method' => 'PUT', 'status' => '1', 'type' => 'error', 'message' => 'Ошибка: Специализация не может быть удален'));
        }
        //}
